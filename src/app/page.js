...
import useUploadStore from '../store/useUploadStore'; // Import the Zustand store
        ...
        <div className="w-[740px] h-[626px] gap-[24px]">
         ...
         <div className="w-[740px] h-auto pt-5 rounded-xl bg-CustomSkin">
              <div className="w-[700px] h-[240px] mx-5 p-4 rounded-xl text-center border-dashed border-light-gray border-2 bg-white flex flex-col justify-center items-center shadow-lg">
                ...
                <label
                  htmlFor="file-upload"
                  className="cursor-pointer text-purple-600 text-[15px] font-extrabold leading-[19.92px] text-left border border-gray-400 py-2 px-6 rounded-full hover:bg-purple-500 hover:text-white transition duration-300 ease-in-out shadow-md"
                >
                  Upload your file
                </label>
              </div>
